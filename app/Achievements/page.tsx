			...
			<main className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
					...
					{achievements.map((achievement, index) => (
						...
						>
							<div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
								{/* Image Section */}
								<div className={`relative h-64 lg:h-auto bg-gray-100 ${index % 2 === 0 ? 'lg:order-1' : 'lg:order-2'}`}>
								...
								{/* Content Section */}
								<div className={`p-8 lg:p-10 flex flex-col justify-center ${index % 2 === 0 ? 'lg:order-2' : 'lg:order-1'}`}>
									<div className="flex items-start gap-3 mb-4">
										...
										<div className="flex-1">
											...
											<p className="text-sm text-gray-500 mt-1">{achievement.issuer}</p>
										</div>
									</div>
				...
				<section className="mt-16 bg-gradient-to-r from-gray-800 to-gray-600 rounded-2xl p-8 md:p-12 text-center text-white">
					...
					<p className="text-gray-200 mb-6 max-w-2xl mx-auto">
						With a proven track record of excellence, I'm ready to bring your vision to life with the same dedication and creativity.
					</p>
