...
export default function ContactPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Yes! I offer unlimited revisions until you're completely satisfied with the design.",
    },
    {
      q: "What file formats do you provide?",
      a: "I provide designs in PNG, JPG, PDF, and source files (AI/PSD) upon request.",
    },
    {
      q: "What are your payment terms?",
      a: "50% deposit to start, 50% upon completion. Payment methods include bank transfer and e-wallets.",
    },
  ];
            ...
            >
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    Send me a direct message for quick inquiries
                  </p>
                  <div className="mt-3">
                    <button
                      onClick={() => {
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    Message me instantly on Telegram for quick responses
                  </p>
                  <div className="mt-3">
                    <a
                      className="inline-block px-3 py-1 text-xs bg-gray-100 rounded-full border border-gray-200"
