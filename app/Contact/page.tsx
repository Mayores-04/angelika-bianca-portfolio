	...
	return (
		<main className="min-h-screen bg-white text-gray-800">
			<section className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
				<h1 className="text-3xl font-semibold text-center text-black">Get In Touch</h1>
				<p className="text-center text-sm text-gray-600 mt-2">Have a project in mind? Let's talk about how we can bring your ideas to life!</p>
