          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
            ...
            <div className="md:w-1/3">
              ...
              <p className="mt-2 text-sm text-gray-800">
                Creative designer and entrepreneur passionate about bringing
                ideas to life through design and innovation.
              </p>
            ...
            <div className="md:w-1/3 flex flex-col items-start md:items-end">
              ...
              <div className="flex items-center gap-2 mt-1">
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Facebook"
                  className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center text-white hover:bg-black transition-colors"
                >
                  <svg
                    fill="none"
                    viewBox="0 0 24 24"
                  ...
                  >
                    <path
                      ...
                      strokeWidth={2}
                      d="M18 2h-3a4 4 0 0 0-4 4v3H7v4h4v8h4v-8h3l1-4h-4V6a1 1 0 0 1 1-1h3V2z"
                    />
                  </svg>
                </a>
                <a
